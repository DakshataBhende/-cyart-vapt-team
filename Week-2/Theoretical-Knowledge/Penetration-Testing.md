...
- Tester has full knowledge (source code, credentials).
- Provides deep coverage.
...
- Information gathering (IPs, domains, services)
- Scanning & Enumeration
- Identifying open ports, running services, versions

2. Vulnerability Analysis

- Mapping weaknesses to known vulnerabilities
  
3. Exploitation

- Attempting to exploit vulnerabilities safely

4. Post-Exploitation

- Privilege escalation, lateral movement analysis
